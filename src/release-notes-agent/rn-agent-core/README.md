...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_rn_agent"></a> [rn\_agent](#module\_rn\_agent) | git::https://github.com/pagopa/payment-release-notes-agent.git//infrastructure/iac | feat/document-generator |
