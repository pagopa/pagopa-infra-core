...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_rn_agent"></a> [rn\_agent](#module\_rn\_agent) | git::https://github.com/pagopa/payment-release-notes-agent.git//infrastructure/iac | 70471e04eda7dc7a860d4bb6c8effb47a16de657 |
