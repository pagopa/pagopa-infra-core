...
| Name | Source | Version |
|------|--------|---------|
| <a name="module___v4__"></a> [\_\_v4\_\_](#module\_\_\_v4\_\_) | git::https://github.com/pagopa/terraform-azurerm-v4 | bcfe51c3d2c05d1e79473154e6ceb160041458d3 |
...
| [azurerm_dns_a_record.dns_a_nexi_at](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_a_record) | resource |
...
| [azurerm_dns_a_record.dns_a_testnexi_at](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_a_record) | resource |
...
| [azurerm_dns_mx_record.additional_mx_record](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_mx_record) | resource |
...
| [azurerm_dns_ns_record.internal_apps_platform_pagopa_it_ns](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_ns_record) | resource |
...
| [azurerm_dns_txt_record.additional_txt_record](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_txt_record) | resource |
...
| [azurerm_dns_txt_record.dns-txt-nexi-ndp-pagopa-it-digicert](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_txt_record) | resource |
...
| [azurerm_dns_txt_record.dns-txt-test-nexi-ndp-pagopa-it-digicert](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_txt_record) | resource |
...
| [azurerm_dns_txt_record.dns-txt-www-nexi-ndp-pagopa-it-digicert](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_txt_record) | resource |
| [azurerm_dns_txt_record.dns-txt-www-test-nexi-ndp-pagopa-it-digicert](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_txt_record) | resource |
...
| [azurerm_dns_zone.ndp_public](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_zone) | resource |
...
| [azurerm_key_vault_access_policy.node_forwarder_app_service_policy](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_access_policy) | resource |
...
| [azurerm_private_dns_zone.privatelink_redis_azure_net](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/private_dns_zone) | resource |
...
| [azurerm_private_dns_zone_virtual_network_link.privatelink_redis_azure_net_vnet](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/private_dns_zone_virtual_network_link) | resource |
...
| <a name="input_enable_low_availability_alert"></a> [enable\_low\_availability\_alert](#input\_enable\_low\_availability\_alert) | Enable availability alert for SA | `bool` | `true` | no |
...
| <a name="input_product_dns_records"></a> [product\_dns\_records](#input\_product\_dns\_records) | Map of product dns records | <pre>map(object({<br/>    email_settings = optional(object({<br/>      amazonses_record = optional(string, null)<br/>      mx_record        = optional(string, null)<br/>      spf_record       = optional(string, null)<br/>      bimi_record      = optional(string, null)<br/>      dmarc_record     = optional(string, null)<br/>      dkim_records = optional(list(object({<br/>        r_name  = string<br/>        r_value = string<br/>      })), [])<br/>    }), null)<br/>    txt_records = optional(list(object({<br/>      r_name  = string<br/>      r_value = string<br/>    })), [])<br/>    mx_records = optional(list(object({<br/>      r_name  = string<br/>      r_value = string<br/>    })), [])<br/>    })<br/>  )</pre> | `{}` | no |
