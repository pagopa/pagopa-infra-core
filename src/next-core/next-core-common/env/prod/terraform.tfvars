...
product_dns_records = {
  "ricevute" = {
    email_settings = {
      ...
      bimi_record      = "v=BIMI1; l=https://assets.cdn.platform.pagopa.it/bimi/mc-bf1l78tjse8.svg; a=https://assets.cdn.platform.pagopa.it/bimi/pagoPA-VMC-full-bundle.pem"
